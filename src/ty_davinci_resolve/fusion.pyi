...
def add_fusion_composition_to_clip(timeline_item: Any) -> FusionCompositionProtocol:
    ...


def get_fusion_tool(comp: Any, name: str) -> FusionToolProtocol:
    ...
...
def set_fusion_tool_input(tool: Any, name: str, value: Any, *, tolerance: float=1e-06) -> None:
    ...
...
def set_fusion_tool_flow_position(comp: Any, tool: Any, position: Sequence[float], *, tolerance: float=0.1, session: ResolveSession | None=None, activate_fusion_page: bool=False) -> None:
    ...
...
def build_fusion_rectangle(comp: Any, rgba: Sequence[float]=(1.0, 1.0, 1.0, 1.0), *, center: Sequence[float]=(0.5, 0.5), width: float=0.1, height: float=0.1, position: Sequence[float]=(0.0, 0.0)) -> Any:
    ...


def build_fusion_line(comp: Any, rgba: Sequence[float], width: float, height: float, *, angle: float=0.0, position: Sequence[float]=(0.0, 0.0), connect_as_foreground: bool=True, center: Sequence[float]=(0.5, 0.5)) -> Any:
    ...
...
def add_fusion_composition_to_timeline(timeline: Any, *, duration_frames: int | None=None, record_frame: int | float | None=None, media_pool: Any | None=None, dummy_media: str | Path | None=None) -> tuple[Any, FusionCompositionProtocol]:
    ...
